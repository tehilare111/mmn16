...
# Custom Exceptions
class DatasetError(AttackException):
    """Raised when user dataset is invalid or missing required data."""
    pass
...
async def brute_force_attack(
    ...
    correct_password = USER_PASSWORDS.get(target_username)
    ...
    report = {
        ...
        "success": success,
        "correct_password": correct_password if success else None,
